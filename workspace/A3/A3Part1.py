...
def generateSinusoid(f1, f2, N, fs):
    '''

    :param f1: frequency 1 (in Hz)
    :param f2: frequency 2 (in Hz)
    :param N:  size of the array (number of samples)
    :param fs: sampling frequency (in Hz)
    :return: a numpy array of real sinusoid signal N long composed by 2 frequencies
    '''
